        ...
        <div className="flex items-center gap-1 bg-gray-700 rounded-lg p-1">
          <button
            ...
            className={`px-3 py-1 text-xs rounded transition-colors ${
              viewMode === 'weekly' ? 'bg-gray-600 text-white' : 'text-gray-400 hover:text-white'
            }`}
          ...
          <button
            ...
            className={`px-3 py-1 text-xs rounded transition-colors ${
              viewMode === 'monthly' ? 'bg-gray-600 text-white' : 'text-gray-400 hover:text-white'
            }`}
                  ...
                  <div key={dateString} className="flex flex-col items-center gap-1">
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-500">
                        {getMonthDay(dateString).split(' ')[1]}
                      </span>
                      <div
                        className={`w-8 h-8 rounded-full border-2 transition-all ${
                          isCompleted ? 'border-transparent scale-110' : 'border-gray-600'
                        }`}
                    ...
                    >
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center text-xs ${
                          isCompleted ? '' : 'border border-gray-600'
                        }`}
                        style={getDateCircleStyle(isCompleted, habit.color)}
                      >
                        {isCompleted ? (
