...
describe('Security Logger', () => {
  ...
  describe('SECURITY_EVENTS', () => {
    it('should export all security event types', () => {
      ...
      expect(SECURITY_EVENTS.PASSWORD_CHANGE_SUCCESS).toBe('PASSWORD_CHANGE_SUCCESS');
      expect(SECURITY_EVENTS.PASSWORD_CHANGE_FAILURE).toBe('PASSWORD_CHANGE_FAILURE');
    });
  });
