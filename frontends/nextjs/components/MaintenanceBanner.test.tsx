...
describe("MaintenanceBanner", () => {
  ...
  describe("when feature flag is enabled", () => {
    ...
    it("should render the banner with default message when no payload", () => {
      ...
      expect(
        screen.getByText(/scheduled maintenance coming soon/i)
      ).toBeInTheDocument();
    });
    ...
    it("should render the banner with custom message from payload", () => {
      ...
      expect(screen.getByRole("alert")).toBeInTheDocument();
      expect(
        screen.getByText(/maintenance on jan 15, 2-3am utc/i)
      ).toBeInTheDocument();
    });
    ...
    it("should fetch payload from the correct feature flag", () => {
      ...
      expect(mockUseFeatureFlagPayload).toHaveBeenCalledWith(
        FEATURE_FLAGS.MAINTENANCE_BANNER
      );
    });
  });
